    ...
    <>
      ...
      <footer className="bg-stone-900 flex flex-col md:flex-row items-center justify-between shadow rounded-t-md py-4 px-6 md:py-6 md:px-8 xl:py-8 xl:px-14 text-center">
        ...
        <div className="flex sm:justify-center space-x-6">
          ...
          <a href="https://www.github.com/SamdeepSharma/" target="_blank" className="text-gray-500 hover:text-neutral-300">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fill-rule="evenodd"
          ...
          <a href="https://www.linkedin.com/in/samdeep-sharma-20894b283/" target="_blank" className="w-6 mx-1 text-gray-500 hover:text-neutral-300">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a href="https://harmonic-horizons.vercel.app/" target="_blank" className="text-gray-500 hover:text-neutral-300">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path
          ...
          <a href="https://i-notebook-cloud-secure.vercel.app/" target="_blank" className="text-gray-500 hover:text-neutral-300">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fill-rule="evenodd"
