    ...
    <>
      <main className="flex-grow flex flex-col items-center justify-center px-4 md:px-24 py-12 bg-gray-100 text-black">
        ...
        <Carousel plugins={[Autoplay({ delay: 2500 })]} className="w-full md:max-w-xs max-w-[250px]">
          ...
          <CarouselPrevious className="hidden md:flex md:justify-center md:items-center" />
          <CarouselNext className="hidden md:flex md:justify-center md:items-center" />
        </Carousel>

      </main>

      <footer className="bg-stone-900 flex flex-col md:flex-row items-center justify-between shadow rounded-t-md py-4 px-6 md:py-6 md:px-8 xl:py-8 xl:px-14 mt-6 text-center">
        <div style={{ color: 'rgb(107, 114, 128)' }} className="mt-2 text-xs md:text-sm mb-3 md:mb-0"><p>Copyright © 2024 | Ghost-Note | All rights reserved.</p></div>
        <div className="flex sm:justify-center space-x-6">
          <a href="https://www.instagram.com/samdeep_.s/" target="_blank" className="text-gray-500 hover:text-gray-900">
            <svg className="h-5 w-5 hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a href="https://www.github.com/SamdeepSharma/" target="_blank" className="text-gray-500 hover:text-gray-900">
            <svg className="h-5 w-5 hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fill-rule="evenodd"
          ...
          <a href="https://www.linkedin.com/in/samdeep-sharma-20894b283/" target="_blank" className="w-6 mx-1 text-gray-500 hover:text-white">
            <svg className="h-5 w-5 fill-current cursor-pointer" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a href="https://harmonic-horizons.vercel.app/" target="_blank" className="text-gray-500 hover:text-gray-900">
            <svg className="h-5 w-5 hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path
          ...
          <a href="https://i-notebook-cloud-secure.vercel.app/" target="_blank" className="text-gray-500 hover:text-gray-900">
            <svg className="h-5 w-5 hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fill-rule="evenodd"
